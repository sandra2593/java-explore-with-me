...
ALTER TABLE events ADD CONSTRAINT fk_events_category FOREIGN KEY (category) REFERENCES users (id) ON DELETE CASCADE;

ALTER TABLE events DROP CONSTRAINT IF EXISTS fk_events_initiator;
ALTER TABLE events ADD CONSTRAINT fk_events_initiator FOREIGN KEY (initiator) REFERENCES categories (id) ON DELETE CASCADE;
...
ALTER TABLE requests ADD CONSTRAINT fk_requests_initiator FOREIGN KEY (requestor) REFERENCES users (id) ON DELETE CASCADE;
