...
ALTER TABLE requests DROP CONSTRAINT IF EXISTS fk_requests_event;
ALTER TABLE requests ADD CONSTRAINT fk_requests_event FOREIGN KEY (event) REFERENCES events (id) ON DELETE CASCADE;
...
ALTER TABLE comments DROP CONSTRAINT IF EXISTS fk_comments_event;
ALTER TABLE comments ADD CONSTRAINT fk_comments_event FOREIGN KEY (event) REFERENCES events (id) ON DELETE CASCADE;

ALTER TABLE comments DROP CONSTRAINT IF EXISTS fk_comments_author;
ALTER TABLE comments ADD CONSTRAINT fk_comments_author FOREIGN KEY (author) REFERENCES users (id) ON DELETE CASCADE;
